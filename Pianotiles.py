...
while True:
    ...
    if threshd[600,70] == 0:
        if flaga:
            cv2.putText(blank, "a", (100,100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0),3)      
        ...
        if flagb:
            cv2.putText(blank, "b", (100,100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0),3)
        ...
        if flagc:
            cv2.putText(blank, "c", (100,100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0),3)
        ...
        if flagd:   
            cv2.putText(blank, "d", (100,100), cv2.FONT_HERSHEY_SIMPLEX, 2, (0,255,0),3)
